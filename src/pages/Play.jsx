...
const Play = () => {
  ...
  const [win5Play, setWin5Play] = useState(false);
  const [lose5Play, setLose5Play] = useState(false);
  ...
  const handleSelectABox = async (boxIndex) => {
    ...
    if (gameResult === false) {
      if (losePlayIndex % 5 === 0) setLosePlay(true);
      if (losePlayIndex % 5 === 1) setLose2Play(true);
      if (losePlayIndex % 5 === 2) setLose3Play(true);
      if (losePlayIndex % 5 === 3) setLose4Play(true);
      if (losePlayIndex % 5 === 4) setLose5Play(true);
      ...
      if (winPlayIndex % 5 === 0) setWinPlay(true);
      if (winPlayIndex % 5 === 1) setWin2Play(true);
      if (winPlayIndex % 5 === 2) setWin3Play(true);
      if (winPlayIndex % 5 === 3) setWin4Play(true);
      if (winPlayIndex % 5 === 4) setWin5Play(true);
      if (losePlayIndex >= 9007199254740990)
  ...
  return (
    <div className="mt-[100px] ">
      ...
      <div style={{ display: "none" }}>
        ...
        {lose5Play ? <LoseSound4 /> : null}
        {lose5Play ? setTimeout(() => setLose5Play(false), 3500) : null}
        {win5Play ? <WinSound4 /> : null}
        {win5Play ? setTimeout(() => setWin5Play(false), 3500) : null}
      </div>
      <Backdrop
